...
namespace Calendar
{
    ...
    public partial class Form1 : Form
    {
        ...
        // this fuction will read data from the user data file
        // every Windows user has his own file/data.
        ...
        private void complete_Click(object sender, EventArgs e)
        {
            ...
            //DateTime date = DateTime.Parse(get);
            ...
            if (tmp2 != null)
            {
                /*int index = this.data.IndexOf(tmp);
                this.data[index] = tmp;*/
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < n && check0 == false; i++)
            {
                ...
                {
                    //doneitms++;
                    //MessageBox.Show(doneitms.ToString());
